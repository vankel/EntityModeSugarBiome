...
public class SugarBiomeCore extends NekonoteCore {
	...
	public void init() {
		...
		if (0 < sugarBlockId) {
			// 砂糖ブロック
			int texture = ModLoader.addOverride("/terrain.png", "/mod/ymt/sugar/sugar01.png");
			sugarBlock = new BlockSugar(sugarBlockId, texture).setBlockName("SugarBlock");
		...
		if (replaceCake) {
			...
			Block newCake = new BlockCake2(Block.cake.blockID, Block.cake.blockIndexInTexture);
